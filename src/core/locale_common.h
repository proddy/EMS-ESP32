...
// common words (alphabetically ordered)
MAKE_WORD(admin)
...
// command-related words (alphabetically ordered)
MAKE_WORD(call)
MAKE_WORD(cmd)
MAKE_WORD(coldshot)
MAKE_WORD(command)
...
// device types - lowercase, used in MQTT (alphabetically ordered)
MAKE_WORD(alert)
...
// data types (alphabetically ordered)
...
// format strings (alphabetically ordered)
...
// optional parameters (alphabetically ordered)
...
// mandatory parameters (alphabetically ordered)
...
// prompts and messages (alphabetically ordered)
...
// common literals - no translation needed
...
// thermostat/controller models (alphabetically ordered)
...
// (alphabetically ordered by suffix)
...
// MQTT topics and prefixes (alphabetically ordered)
